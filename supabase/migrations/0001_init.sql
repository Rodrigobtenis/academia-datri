...
-- OJO: enrollments y payments son un join 1-a-muchos (una inscripción puede tener
-- varios pagos). Sumar en.final_price en la misma consulta que hace join con payments
-- duplica ese final_price una vez por cada pago de la inscripción ("fan-out"). Por eso
-- el total vendido se calcula en un CTE aparte, sin tocar payments.
